...
from src.mia.audio.audio_resource_manager import (  # type: ignore
    AudioResource,
    AudioResourceManager,
)

# Import the modules we're testing
from src.mia.config_manager import (  # type: ignore
    AudioConfig,
    ConfigManager,
    LLMConfig,
    SystemConfig,
...
from src.mia.multimodal.vision_resource_manager import (
    VisionResource,
...
class TestAudioResourceManager(unittest.TestCase):
    ...
    def test_audio_resource_acquisition(self):
        ...
        resource = self.audio_manager.acquire_audio_resource(
            "test_audio", mock_audio_component
        )
...
class TestVisionResourceManager(unittest.TestCase):
    ...
    def test_vision_resource_acquisition(self):
        ...
        resource = self.vision_manager.acquire_vision_resource(
            "test_vision", mock_vision_component
        )
